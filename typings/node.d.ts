...
declare module "stream" {
    ...
    namespace internal {
        ...
        export class Readable<DataType = string | Buffer> extends Stream {
            readable: boolean;
            ...
            resume(): this;
            isPaused(): boolean;
            pipe<T extends Writable<DataType>>(destination: T, options?: { end?: boolean; }): T;
            unpipe<T extends Writable<DataType>>(destination?: T): this;
